...
def main():
    ...
    for i in tqdm(range(0, len(messages), args.batch_size)):
        ...
        # generated_ids = reasoning_model.generate(**inputs, use_cache=True, max_new_tokens=1200, do_sample=False)
        generated_ids = reasoning_model.generate(**inputs, use_cache=True, max_new_tokens=3000, do_sample=True, temperature=1.0,top_p=1.0,top_k=0)
            ...
            for id_idx in range(len(batch_output_text)):
                try:
                    ...
                    all_outputs.append({
                        ...
                        "think": think,
                        "raw_answer": batch_output_text[id_idx],
